...
const About = () => {
  return (
    <>
      <section className="about bg-gray-50 dark:bg-gray-900 py-16">
        <div className="container mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center gap-8">
          <div className="left row md:w-1/2">
            ...
            <main className="mt-4 text-lg leading-relaxed text-gray-800 dark:text-gray-200">
            ...
            <main className="mt-4 text-lg leading-relaxed text-gray-600 dark:text-gray-400">
