    ...
    <div className="mx-auto p-4">
      ...
      <div className="flex flex-wrap gap-4 mb-6 justify-center">
        ...
        <input
          ...
          className="w-[15%] max-w-[20%]  text-black px-4 py-2 rounded-md"
        />
        <input
          type="number"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredTalents.map((candidate) => (
          <div
            ...
            className="border-gray-200 rounded-lg shadow-lg overflow-hidden flex flex-col border-2 p-4 text-white"
          >
            <img
