...
export const Notifications = async function (req, res) {
  try {
    const notifications = await Notification.find().populate("JobDetails");
...
export const NotificationsById = async function (req, res) {
  try {
    ...
    const notifications = await Notification.findById(req.body.notificationId).populate("JobDetails");
